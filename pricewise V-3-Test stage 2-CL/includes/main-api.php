...
function pricewise_api_settings_page() {
    ...
    <div class="wrap">
        ...
        <h2>Test Stage 1 API (Destination Auto-Complete)</h2>
        <form method="post">
        ...
        <hr>
        <h2>Test Stage 2 API (Hotel Search by Destination)</h2>
        <form method="post">
...
function pricewise_register_api_settings() {
    ...
    // Stage 1 API Configuration (Destination Auto-Complete)
    add_settings_section(
        'pricewise_api_settings_section',
        'Stage 1 API Configuration',
        'pricewise_api_settings_section_callback',
        'pricewise-api-settings'
    );
    add_settings_field(
        'api_key',
        'RapidAPI Key (Stage 1)',
    ...
    add_settings_field(
        'api_endpoint',
        'API Endpoint (Stage 1)',
        'pricewise_api_endpoint_callback',
        'pricewise-api-settings',
        'pricewise_api_settings_section'
    );

    // Stage 2 API Configuration (Hotel Search by Destination)
    add_settings_section(
...
function pricewise_api_settings_section_callback() {
    echo 'Enter your RapidAPI configuration details for Stage 1 (Destination Auto-Complete) below:';
}
...
function pricewise_api_stage2_section_callback() {
    echo 'Enter your RapidAPI configuration details for Stage 2 (Hotel Search by Destination) below:';
}
 ...
 */
require_once plugin_dir_path( __FILE__ ) . 'rapidapi/rapidapi-hotels-dest-1st.php';
require_once plugin_dir_path( __FILE__ ) . 'rapidapi/rapidapi-hotels-deta-2nd.php';
require_once plugin_dir_path( __FILE__ ) . 'rapidapi/rapidapi-hotels-sear-3rd.php';
